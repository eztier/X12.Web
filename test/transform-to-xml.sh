...
curl -XPOST -H 'Content-Type: application/x-www-form-urlencode' --data-binary @/home/htao/X12.Web/test/fixtures/837/5010/UnicodeExample.txt http://localhost:8168/Hippa/transform/x12/xml
